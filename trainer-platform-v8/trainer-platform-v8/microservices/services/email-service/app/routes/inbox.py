...
from app.gmail_client import check_gmail_oauth_replies, check_imap_replies, send_email_async
...
async def _process_client_requirement_email(
    ...
    is_client_requirement_template = bool(
        extracted.get("is_training_request")
        and (
            selected_template_key in {"client_proceed_ack", "client_missing_details", "client_full_details_received"}

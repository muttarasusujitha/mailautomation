...
export const getTrainerLocations  = ()    => api.get('/trainers/locations')
export const getTrainerLocationGroups = (params) => api.get('/trainers/location-groups', { params })
...
export const searchPeopleIntelligence = (data) => api.post('/intelligence/people-search', data)

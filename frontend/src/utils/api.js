...
export const analyzeVoiceAI = (transcript) => api.post('/voice-ai/analyze', { transcript })
export const saveVoiceAINote = (transcript) => api.post('/voice-ai/notes', { transcript })
export const createVoiceAITask = (transcript, payload = {}) => api.post('/voice-ai/tasks', { transcript, ...payload })
export const executeVoiceAIAction = (transcript, payload = {}) => api.post('/voice-ai/execute', { transcript, ...payload })
export const getVoiceAINotes = (params = {}) => api.get('/voice-ai/notes', { params })
export const getVoiceAITasks = (params = {}) => api.get('/voice-ai/tasks', { params })
...
export const getCommercialAnalyses = (params = {}) => api.get('/requirements/analysis/commercial', { params })
export const getCommercialAnalysis = (id) => api.get(`/requirements/${id}/commercial-analysis`)
export const getAgentRoles = () => api.get('/agent-orchestrator/roles')
